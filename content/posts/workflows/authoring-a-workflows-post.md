...
description = "How to publish a process doc from a project repo as a workflows post, keeping one source for the LLM that follows it and the people who read it."
