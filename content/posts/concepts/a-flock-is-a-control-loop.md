...
The same flock, scaled up to thousands of boids, is where the performance questions get interesting. In [Two Languages, Two Bottlenecks](/posts/concepts/two-languages-two-bottlenecks/) I dig into why the right optimization is completely different in Python and in Rust.
