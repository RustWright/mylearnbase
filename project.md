...
**Remaining Cycle 5:** Task 5 still has its two *candidate* items (search-ranking / TF-IDF concepts demo; reader-facing logbook candidate(s) — the content-based "Related" nav and the colophon/privacy page). Both are candidates, not commitments (zero concepts/logbook in a cycle is normal).
